...
if(isset($_POST['varifyt']))
{
	$verify_otp = $_POST['otp-email'];
								...
								<div class="col-lg-12">
									...
									<form id="register-form"  method="post" role="form" autocomplete="off">
										<div class="form-group">
											...
											<input type="email" name="otp-email" id="otp-email" tabindex="1" class="form-control" placeholder="enter OTP" value="" autocomplete="off" />
										</div>
										<div class="form-group">
											<div class="row">
