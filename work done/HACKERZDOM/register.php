...
echo "<script>alert('otp has been send to yur account');</script>";
   $mail = new PHPMailer;
...
$mail->Password = 'wMu.?S^VRauX';               // SMTP password
$mail->SMTPSecure = 'ssl';                            // Enable encryption, 'ssl' also accepted
$mail->Port = 465;       
/*$mail->SMTPDebug = 2;*/                             //Set the SMTP port number - 587 for authenticated TLS
$mail->setFrom('hemant@hackerzdom.com', 'hackerzdom');     //Set who the message is to be sent from
