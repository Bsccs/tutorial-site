                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $data['content_name']; ?></td>
                                    <td align="center"><?php if($data['inspector_approved']==0) { ?><a class="btn btn-block btn-danger btn-sm" 
                                    href="approve.php?pst_id=<?php echo $data['content_id']; ?>">APPROVE</a><?php } else { ?><a class="btn btn-block btn-success">APPROVED</button> <?php } ?></td>
